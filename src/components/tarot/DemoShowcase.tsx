...
export function DemoShowcase() {
  ...
  return (
    <section className="w-full py-32 px-4 bg-[#fcfcfc] overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-black/40 font-sans max-w-lg mx-auto">
            {language === 'zh' 
              ? "从提问、择阵到洞察，沉浸式的灵性交互流。" 
        ...
        <div className="relative w-full max-w-4xl mx-auto aspect-[16/10] md:aspect-[16/9] bg-white rounded-xl shadow-2xl border border-black/5 overflow-hidden flex flex-col">
          
          {/* Mock Browser Header */}
          <div className="h-12 border-b border-black/5 flex items-center px-4 gap-2 bg-[#fcfcfc]">
            ...
            <div className="flex-1 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-black/5 text-[10px] font-sans text-black/40 tracking-widest uppercase">
            ...
            {steps.map((step) => (
              <div 
                ...
                className={cn(
                  ...
                  activeStep === step.id ? "w-8 bg-emerald-500" : "w-2 bg-black/10"
                )}
              />
            ))}
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {activeStep === 0 && (
                <motion.div
                  ...
                  className="absolute inset-0 flex flex-col items-center justify-center p-8 bg-black/[0.02]"
                >
                  <div className="w-full max-w-2xl space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {/* Active Option */}
                      <div className="relative bg-white p-4 rounded-xl border-2 border-black/10 shadow-lg flex flex-col gap-3 group cursor-pointer ring-1 ring-black/5">
                        ...
                        <div className="flex gap-1 h-12 items-center justify-center opacity-50">
                           <div className="w-8 h-12 border border-black/20 bg-white rounded-[2px]" />
                           <div className="w-8 h-12 border border-black/20 bg-white rounded-[2px]" />
                           <div className="w-8 h-12 border border-black/20 bg-white rounded-[2px]" />
                        </div>
                        ...
                        >
                          <div className="w-4 h-4 bg-black rounded-full opacity-20 animate-ping absolute" />
                      ...
                      {/* Inactive Option */}
                      <div className="bg-white/50 p-4 rounded-xl border border-black/5 flex flex-col gap-3 opacity-60">
                        <div className="flex justify-between items-start">
                          <span className="font-serif text-lg">
                            {language === 'zh' ? "单一洞察" : "Single Insight"}
                          </span>
                        </div>
                        <div className="flex gap-1 h-12 items-center justify-center opacity-30">
                           <div className="w-8 h-12 border border-black/20 bg-white rounded-[2px]" />
                        </div>
                        <p className="text-xs text-black/50">
              ...
              {activeStep === 1 && (
                ...
                >
                  ...
                  <div className="w-full max-w-md space-y-4">
                    <div className="w-full h-12 rounded-full border border-black/10 flex items-center px-6 text-black/30 font-sans text-sm bg-white shadow-sm relative overflow-hidden">
                      <motion.span
                        initial={{ width: "0%" }}
                        animate={{ width: "100%" }}
                        transition={{ duration: 2, delay: 0.5, ease: "linear" }}
                        className="whitespace-nowrap overflow-hidden inline-block text-black/60"
                      >
                        {language === 'zh' ? "关于事业发展，我需要知道什么？" : "What should I know about my career?"}
                      </motion.span>
                      <span className="ml-1 animate-pulse border-r border-black/40 h-4 inline-block align-middle" />
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      {[
                        ...
                        <motion.span 
                          ...
                          className="px-3 py-1 rounded-full bg-black/5 text-xs text-black/50"
                        >
                          {tag}
                        </motion.span>
                      ))}
                  ...
                  <motion.div 
                    ...
                    className="pt-8"
                  >
                    <button className="px-8 py-3 bg-black text-white rounded-full font-serif tracking-widest text-xs uppercase flex items-center gap-2 shadow-lg hover:scale-105 transition-transform duration-300">
              ...
              {activeStep === 2 && (
                ...
                >
                  <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-3xl w-full">
                    ...
                    >
                      <div className="relative w-full aspect-[2/3.5] rounded-lg shadow-lg border border-black/5 overflow-hidden bg-white translate-y-4">
                        <Image 
                      ...
                      >
                        ...
                        <p className="text-xs md:text-sm font-serif text-black/70">
                    ...
                    <motion.div 
                      ...
                      className="flex flex-col items-center gap-4 group"
                    >
                      <div className="relative w-full aspect-[2/3.5] rounded-lg shadow-xl border border-black/5 overflow-hidden bg-white -translate-y-4 z-10 ring-4 ring-black/5">
                        <Image 
                      ...
                      <motion.div 
                        ...
                        className="text-center space-y-1"
                      >
                        <span className="text-[10px] uppercase tracking-widest text-emerald-600/60">
                          {language === 'zh' ? "现在" : "PRESENT"}
                        </span>
                        <p className="text-xs md:text-sm font-serif text-black">
              ...
              {activeStep === 3 && (
                ...
                >
                  {/* Left: Cards Context */}
                  <div className="hidden md:flex w-1/3 bg-slate-50 border-r border-black/5 p-6 flex-col items-center justify-center gap-4">
                    <motion.div 
                      initial={{ scale: 0.8, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      transition={{ delay: 0.2 }}
                      className="relative w-32 aspect-[2/3.5] rounded-md shadow-md border border-black/5 overflow-hidden rotate-[-2deg]"
                    >
                       <Image 
                          src={language === 'zh' ? "/cards/major-2.jpg" : "/cards/swords-9.jpg"} 
                    ...
                    >
                      <p className="text-xs font-serif text-black/50">
                  ...
                  <div className="flex-1 p-8 md:p-12 overflow-y-auto relative">
                    <div className="space-y-8">
                      <motion.div 
                        ...
                        className="space-y-2"
                      >
                        <span className="text-[10px] uppercase tracking-widest text-emerald-600">Lumin Analysis</span>
                      ...
                      <div className="space-y-6 text-sm md:text-base font-serif text-black/70 leading-relaxed">
                        <motion.p
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          transition={{ delay: 1.0 }}
                      ...
                      >
                        <button className="px-4 py-2 bg-black/5 rounded-full text-xs hover:bg-black/10 transition-colors">
            ...
            {steps.map((step) => (
              <button
                ...
                className={cn(
                  ...
                  activeStep === step.id ? "bg-black scale-125" : "bg-black/20 hover:bg-black/40"
                )}
